...
MySQL - 5.5.53 : Database - graduationdesign
*********************************************************************
*/
...
CREATE TABLE `choosecur` (
  ...
  `stuID` int(6) unsigned zerofill DEFAULT NULL,
  `chooseTime` varchar(255) DEFAULT NULL,
  `endTime` varchar(255) DEFAULT NULL,
  `curTeacher` varchar(255) DEFAULT NULL,
  `curTime` varchar(255) DEFAULT NULL,
  `state` int(1) DEFAULT '1' COMMENT '课程状态，1为未结束',
...
insert  into `choosecur`(`curID`,`curName`,`stuID`,`chooseTime`,`endTime`,`curTeacher`,`curTime`,`state`,`StuEvaluate`,`teacherEva`,`StuEvaluateTime`) values (00000002,'CSS的美化功能',000003,'2020-02-03-15:34:06','2020-02-04-15:34:06','赵丽伟','18',1,NULL,9,NULL),(00000011,'PHP零基础教程',000003,'2020-02-03-15:34:19','2020-02-04-15:34:19','李毅','21',1,NULL,0,NULL),(00000016,'Python教程',000001,'2020-02-05-14:14:07','2020-02-06-14:14:07','戴应','20',1,NULL,0,NULL),(00000005,'HTML+CSS 轻松入门教程',000001,'2020-02-05-14:00:32','2020-02-06-14:00:32','赵丽伟','16',1,NULL,0,NULL);
...
CREATE TABLE `students` (
  ...
  `paid` varchar(255) DEFAULT '5',
  `state` varchar(20) DEFAULT '正常',
  `choosed` int(1) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `students` */

insert  into `students`(`ID`,`userName`,`password`,`name`,`phone`,`qq`,`email`,`university`,`grade`,`paid`,`state`,`choosed`) values (123321,'QQ','123321','赖林靓','12345678902',NULL,NULL,NULL,NULL,'5','正常',0),(123456,'LL','123456','赖最最','12345678904',NULL,NULL,NULL,NULL,'5','封禁',0),(000001,'PX','123456','郑贤琳','12345678903','823145731','PX@qq.com','北京大学','计算1692','4','正常',2),(000002,'PP','123321','Peter','12345678901',NULL,NULL,NULL,NULL,'5','正常',0),(000003,'ZZZ','123321','梁勇','12345678901','111111','12321@13.com','集美大学','计算17','5','正常',1),(000010,NULL,'123321','张三','12345670111','123321','qwe@qq.com','','财经1792','5','正常',0);
